...
VCAPS_LINE="video/x-raw, width=(int)320, height=(int)240, pixel-aspect-ratio=(fraction)1/1, framerate=(fraction)30/1, encoding-name=(string)JPEG"
...
raspivid -n -e -w 960 -h 540 -b 10000000 -fps 30 -t 0 -o - | \
